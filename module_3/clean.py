...
(copied from module 2 - used after scraping to clean the data before loading into PostgreSQL)
...
if __name__ == "__main__":
    ...
    # the LLM enrichment step (llm_hosting/app.py) is available in module_2
    # but we skip it here since module_3 only uses clean data for loading into PostgreSQL
    # new entries added via Pull Data won't have llm-generated fields (those cols will be NULL)
    print("\nCleaning done. LLM enrichment skipped (run from module_2 if needed).")
